...
textField.addEventListener("input", () => {
  ...
  const numberofWords = document.querySelector('li[data-name="numberofWords"]');
  numberofWords.textContent = "Number of words:" + numofWords;

  // 2. Setea conteo de caracteres
  const numbfCharacters = document.querySelector('li[data-name="numofCharacters"]');
  numbfCharacters.textContent = "Number of Characters: " + numofCharacters;
  
  // 3. SETEA CONTEO DE CARACTERES SIN ESPACIO
  const numbfCharactersExcludingSpaces = document.querySelector('li[data-name="numofCharactersExcludingSpaces"]');
  numbfCharactersExcludingSpaces.textContent = "Number of Characters Excluding Spaces : " + numofCharactersExcludingSpace;

  // 4. SETEA GETAVERAGE

  const numberofaverageWordLength = document.querySelector('li[data-name="numberofaverageWordlength"]');
  numberofaverageWordLength.textContent = "Average Word Length :" + averageWordLength;

  //5. setea numbercount

  const numberofnumbercount = document.querySelector('li[data-name="numberofnumbercount"]');
  numberofnumbercount.textContent = "Number Count :" + numberCount;


  // SETEA NUMBERSUM
  const numberofnumberSum = document.querySelector('li[data-name="numberofnumbersum"]');
